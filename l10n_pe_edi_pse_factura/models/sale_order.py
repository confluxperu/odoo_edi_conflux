        ...
        if self.is_downpayment:
            ...
            if len(self.invoice_lines)>0:
                ...
                if invoice[0].move_id.journal_id.l10n_latam_use_documents:
                    ...
                    l10n_pe_edi_downpayment_ref_type = ''
                    if code_invoice=='01':
                        l10n_pe_edi_downpayment_ref_type = '02'
                    elif code_invoice=='03':
                        l10n_pe_edi_downpayment_ref_type = '03'
                    res['l10n_pe_edi_downpayment_ref_type'] = l10n_pe_edi_downpayment_ref_type
                    l10n_pe_edi_downpayment_ref_number = invoice[0].move_id.name.replace(' ','')
                    res['l10n_pe_edi_downpayment_ref_number'] = l10n_pe_edi_downpayment_ref_number
