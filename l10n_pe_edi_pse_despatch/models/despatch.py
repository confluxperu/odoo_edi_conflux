...
class LogisticDespatch(models.Model):
    ...
    l10n_pe_edi_shipment_reason = fields.Selection('get_l10n_pe_edi_shipment_reason', string='Reason', required=True, readonly=True, states={
                                       'draft': [('readonly', False)], }, default='01')
    l10n_pe_edi_transport_mode = fields.Selection('get_l10n_pe_edi_transport_mode', string='Mode', required=True, readonly=True, states={
    ...
    l10n_pe_edi_mtc_authorization = fields.Char('Autorizacion MTC', related='carrier_id.l10n_pe_edi_mtc_authorization', readonly=False)
    l10n_pe_edi_vehicle_2 = fields.Many2one('fleet.vehicle','Vehiculo Secundario 1')
    l10n_pe_edi_vehicle_3 = fields.Many2one('fleet.vehicle','Vehiculo Secundario 2')
    ...
    def action_open(self):
        ...
        for move in self:
            log.info(move.journal_id.edi_format_ids.mapped('code'))
            if 'pe_pse' in move.journal_id.edi_format_ids.mapped('code'):
    ...
    def _l10n_pe_prepare_dte(self):
        ...
        _despatch = {
            ...
            'tipo_de_guia': '09',
            'informacion_de_envio': self.l10n_pe_edi_shipment_reason,
